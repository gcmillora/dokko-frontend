          ...
          <div className="flex items-center p-8">
            <div className="mr-4 h-[50px] w-full max-w-[50px] rounded-full">
              <Image
                ...
                height={50}
                alt="profile"
                className="h-full w-full rounded-full object-cover object-center border border-stroke border-2 border-primary"
              />
            </div>
            <div>
              <p className="font-medium text-body-color">Welcome!</p>
