...
export default function Page({ params }: pageProps) {
  ...
  return (
    <div className="px-16 pt-24 h-screen flex flex-col">
      ...
      {appointments.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full">
          <p className="text-body-color text-sm font-medium">
            No appointments have been booked by patients.
          </p>
        </div>
      ) : (
        <div>
          <div className="shrink rounded-lg bg-white mt-4 border-form-stroke border max-h-max">
            <div className="max-w-full h-full overflow-auto">
              <table className="w-full  h-full table-auto overflow-auto ">
                <thead>
                  <tr className="bg-primary">
                    ...
                    <th className="min-w-[220px] py-6 px-4">
                      <p className="text-left text-base font-medium text-white">
                        Date
                      </p>
                    </th>
